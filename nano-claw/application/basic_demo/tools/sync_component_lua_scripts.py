...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='Sync component Lua scripts into the basic_demo FATFS image.'
    )
    ...
    parser.add_argument(
        '--main-dir',
        help='Optional basic_demo main directory whose lua_scripts should be treated as builtin scripts.',
    )
